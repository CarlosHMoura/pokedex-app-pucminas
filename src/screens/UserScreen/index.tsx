...
import { UserScreenView, UserContainer, UserItem, UserInput, Text, BoldText, ErrorText } from "./styles";
            ...
            {user ? (
                <UserContainer>
                    ...
                    <UserItem>
                        ...
                        <Text>{user.birthday.replace(/(\d{2})(\d{2})(\d{4})/, '$1/$2/$3')}</Text>
                    </UserItem>
                    <UserItem>
                    ...
                    <UserItem>
                        ...
                        <Text>{user.phone.replace(/(\d{2})(\d{5})(\d{4})/, '($1) $2-$3')}</Text>
                    </UserItem>
                    <UserItem>
                        <BoldText>Pokémons Favoritos: </BoldText>
